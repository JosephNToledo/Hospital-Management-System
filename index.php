        ...
        <div class = "header-inner text-white text-center">
            <div class = "container grid">
                <div class = "header-inner-left">
                    <h1>your most trusted<br> <span>healthcare provider</span></h1>
                    <p class = "lead">providing you with many healthcare services</p>
    ...
    <main>
        ...
        <section id = "banner-one" class = "banner-one text-center">
            <div class = "container text-white">
                <blockquote class = "lead"></i>Our Healthcare Management Website is here to streamline patient care</i></blockquote>
            </div>
        </section>
        <!-- end of banner one -->
        ...
        <section id = "services" class = "services py">
            <div class = "container">
                <div class = "section-head text-center">
                    <h2 class = "lead">Easily View Your Records</h2>
                    <p class = "text text-lg">Your results are a click away</p>
